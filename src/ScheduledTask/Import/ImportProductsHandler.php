...
class ImportProductsHandler extends ScheduledTaskHandler
{
    ...
    {
        return $this->systemConfigService->get('AmbimaxGlobalsysConnect.config.importProductsInterval');
    }
