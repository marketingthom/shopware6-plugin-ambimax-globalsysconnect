...
class ImportStockHandler extends ScheduledTaskHandler
{
    ...
    {
        return $this->systemConfigService->get('AmbimaxGlobalsysConnect.config.importStockInterval');
    }
